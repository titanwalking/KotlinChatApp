...
import com.colossussoftware.titanwalking.kotlinchatapp.model.MessageType
import com.colossussoftware.titanwalking.kotlinchatapp.model.TextMessage
...
class ChatActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if(requestCode == RC_SELECT_IMAGE && resultCode == Activity.RESULT_OK && data != null && data.data != null){
            ...
            StorageUtil.uploadMessageImage(imageBytes){
                imagePath -> val messageToSend =

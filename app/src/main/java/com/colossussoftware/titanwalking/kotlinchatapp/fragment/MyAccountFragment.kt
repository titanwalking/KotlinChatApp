...
import com.colossussoftware.titanwalking.kotlinchatapp.SignInActivity
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        view.apply {
            imageView_profile_picture.setOnClickListener {
                ...
                startActivityForResult(Intent.createChooser(intent, "Select an image"), RC_SELECT_IMAGE)
            }
